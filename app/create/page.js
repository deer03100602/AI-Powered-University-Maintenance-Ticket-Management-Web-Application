...
import { PlusCircle, Info, User, Send, Loader, UploadCloud, FileText, X, Image as ImageIcon, Plus, Trash2 } from 'lucide-react';
            ...
            <form className="ticket-form glass-card" onSubmit={handleSubmit}>
                ...
                <div className="form-section">
                    ...
                    <div className="form-group">
                        ...
                        />
                        <span className="form-hint">อธิบายปัญหาสั้นๆ ชัดเจน</span>
                    </div>
                    ...
                    <div className="form-group">
                        ...
                        <textarea 
                            ...
                            placeholder="อธิบายรายละเอียดปัญหา เช่น อาการ สิ่งที่ลองทำแล้ว ฯลฯ" 
                            required 
                            rows={4}
                            value={description}
                    ...
                    <div className="form-row">
                        ...
                        <div className="form-group">
                            <label className="form-label">ระดับความสำคัญ <span className="required">*</span></label>
                            <select 
                                className="form-input form-select" 
                                required
                                value={priority}
                    ...
                    <div className="form-group">
                        <label className="form-label">สถานที่ <span className="required">*</span></label>
                        <input 
                            type="text" 
                            className="form-input" 
